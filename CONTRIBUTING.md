...
1. Make an [Issue](https://github.com/louthy/languageext/issues/new)
...
```json
    {
        "dependencies": {
            "com.louthy.languageext": "https://github.com/YOUR_USER/languageext.git"
        }
    }
```
...
reported to the community leaders responsible for enforcement at jessebracho@gmail.com.
